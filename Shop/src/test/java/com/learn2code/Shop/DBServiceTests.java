...
//        if (merchant == null){
//            merchant = new Merchant("MerchantName", "MerchantEmail","MerchantAddress");
...
//    }
    ...
    public void customer(){
        Customer customer = new Customer("Ferko","Mrkvicka","email","adresa",20,"mobil");
    ...
    public void merchant(){
        Merchant merchant = new Merchant("MerchantName", "MerchantEmail","MerchantAddress");
    ...
    @Test
    public void product(){
        Product product = new Product(merchant.getId(),"NameProduct","ProductDescription",1000.0d,100);
...
//
//        //(String name, String descrition, double price, int available)
...
//
//        Product productAfterUpdate = productService.get(id);
//        Assert.assertEquals(product,productAfterUpdate);
//        Assert.assertEquals(fromDB,productAfterUpdate);
//
//        productService.delete(id);
//        Assert.assertEquals(0,products.get(0));
