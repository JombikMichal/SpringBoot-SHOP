...
public class ProductRepository {
    ...
    public void update(int id, UpdateProductRequest request){
        final String sql = "UPDATE product SET product name=?, description=?, price=?, available=? where id=?";
        jdbcTemplate.update(sql,request.getName(),request.getDescrition(),request.getPrice(),request.getAvailable(),id);
    }
